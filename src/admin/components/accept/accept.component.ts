...
import { Client_Entity } from '../../model-admin';
...
export class AcceptComponent implements OnInit{
 ...
 v1:any; 
  ...
  ngOnInit(): void {
    this.Serves.get_user().subscribe((d:any)=>{
      this.list=d;
      console.log(this.list)},(e:any)=>{console.log(e)});
...
yes(i:any){
  ...
  this.Serves.dalete_users(this.list[i].id).subscribe((d:any)=>{
    console.log(d)},(e:any)=>{console.log(e)})
